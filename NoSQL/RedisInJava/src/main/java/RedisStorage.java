...
public class RedisStorage {
    ...
    void addUser(int numberOfUser, int user)
    {
        //ZADD ONLINE_USERS
        onlineUsers.add(numberOfUser, String.valueOf(user));
    }

    int getUsersValue(int numberOfUser){
        redisson.getScoredSortedSet(String.valueOf(numberOfUser));
        return numberOfUser;
    }
